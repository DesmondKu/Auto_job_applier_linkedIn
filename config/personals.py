...
# Your legal name
first_name = "Ku"                 # Your first name in quotes Eg: "First", "Sai"
middle_name = ""            # Your name in quotes Eg: "Middle", "Vignesh", ""
last_name = "Ming Zhun"                # Your last name in quotes Eg: "Last", "Golla"

# Phone number (required), make sure it's valid.
phone_number = "0412362994"        # Enter your 10 digit number in quotes Eg: "9876543210"

# What is your current city?
current_city = "Brisbane, Australia"                  # Los Angeles, San Francisco, etc.
'''

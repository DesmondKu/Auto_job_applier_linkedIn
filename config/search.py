...
search_terms = ["Data S Scientist", "Data Engineer", "Data Analyst", "Data Architect", "Business Analyst", "Cloud Engineer", "Machine Learning Engineer", "Business Intelligence Analyst", "Reporting Analyst", "Software Engineer"]

# Search location, this will be filled in "City, state, or zip code" search box. If left empty as "", tool will not fill it.
search_location = "Australia", "Sydney",  "Brisbane",  "Melbourne", "Perth"              # Some valid examples: "", "United States", "India", "Chicago, Illinois, United States", "90001, Los Angeles, California, United States", "Bengaluru, Karnataka, India", etc.
...
about_company_bad_words = []       # (dynamic multiple search) or leave empty as []. Ex: ["Crossover", "Staffing", "Recruiting", "Name of Company you don't want to apply to"]
...
bad_words = []                     # (dynamic multiple search) or leave empty as []. Case Insensitive. Ex: ["word_1", "phrase 1", "word word", "polygraph", "US Citizenship", "Security Clearance"] "US Citizen","USA Citizen","No C2C", "No Corp2Corp", ".NET", "Embedded Programming", "PHP", "Ruby", "CNC"
